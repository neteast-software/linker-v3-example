...
func (p Store) SaveDefaults(ctx context.Context, tasks ...Task) error {
	if len(tasks) == 0 {
		return nil
	}
...
func (p Store) List(ctx context.Context, app application.Application, req ListRequest) ([]Task, query.Page, error) {
